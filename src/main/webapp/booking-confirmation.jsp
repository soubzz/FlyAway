...
<body>
	<div class="container">
		<div class="row">
			<div class="col">
				<div>
					<div class="h1 text-center" style="color: #0eb1e6">FlyAway - Ticket Confirmation</div>
					<br>
					<div class="card">
						<div class="card-header h4">Booking Details</div>
						<div class="card-body">
										...
										<br>
											<div class="mb-3">
												<button class="btn btn-info" type="submit"
													style="width: 250px">Proceed to the Payment</button>
											</div>
									</div>
								</div>
							</div>
